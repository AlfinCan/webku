           ...
           <Row className="header-box d-flex align-items-center">
            <Col lg="6">
             <h1 className="mb-4 animate__animated animate__fadeInUp animate__delay-1s">
                Join Kelas <br /> <span>Dan Temukan</span> <br />Bakatmu Disini!
             </h1>
             <p className="mb-4 animate__animated animate__fadeInUp animate__delay-1s">Lorem ipsum dolor sit amet consectetur adipisicing elit. Omnis ratione fugit aspernatur nemo 
             facere sapiente.</p>
